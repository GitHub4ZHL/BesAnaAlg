...
#cmt_local_tagfile = $(SampleAlg_tag).make
cmt_local_tagfile = $(bin)$(SampleAlg_tag).make
...
cmt_local_setup_SampleAlg = $(bin)setup_SampleAlg$$$$.make
...
SampleAlg_extratags = -tag_add=target_SampleAlg

#$(cmt_local_tagfile_SampleAlg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_SampleAlg) ::
else
$(cmt_local_tagfile_SampleAlg) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_SampleAlg); then /bin/rm -f $(cmt_local_tagfile_SampleAlg); fi ; \
	  $(cmtexe) -tag=$(tags) $(SampleAlg_extratags) build tag_makefile >>$(cmt_local_tagfile_SampleAlg)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_SampleAlg)"; \
	  test ! -f $(cmt_local_setup_SampleAlg) || \rm -f $(cmt_local_setup_SampleAlg); \
	  trap '\rm -f $(cmt_local_setup_SampleAlg)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(SampleAlg_extratags) show setup >$(cmt_local_setup_SampleAlg) && \
	  if [ -f $(cmt_final_setup_SampleAlg) ] && \
	    \cmp -s $(cmt_final_setup_SampleAlg) $(cmt_local_setup_SampleAlg); then \
	    \rm $(cmt_local_setup_SampleAlg); else \
	    \mv -f $(cmt_local_setup_SampleAlg) $(cmt_final_setup_SampleAlg); fi
...
not_SampleAlg_dependencies = { n=0; for p in $?; do m=0; for d in $(SampleAlg_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SampleAlgdirs :
	@if test ! -d $(bin)SampleAlg; then $(mkdir) -p $(bin)SampleAlg; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SampleAlg
else
SampleAlgdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)SampleAlg
#
#$(cmt_local_SampleAlg_makefile) :: $(SampleAlg_dependencies) $(cmt_local_tagfile_SampleAlg) build_library_links dirs SampleAlgdirs
#else
#$(cmt_local_SampleAlg_makefile) :: $(SampleAlg_dependencies) $(cmt_local_tagfile_SampleAlg) build_library_links dirs
#endif
#else
#$(cmt_local_SampleAlg_makefile) :: $(cmt_local_tagfile_SampleAlg)
#endif

ifdef cmt_SampleAlg_has_target_tag

ifndef QUICK
$(cmt_local_SampleAlg_makefile) : $(SampleAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building SampleAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(SampleAlg_extratags) build constituent_config -out=$(cmt_local_SampleAlg_makefile) SampleAlg
else
$(cmt_local_SampleAlg_makefile) : $(SampleAlg_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SampleAlg) ] || \
	  [ ! -f $(cmt_final_setup_SampleAlg) ] || \
	  $(not_SampleAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SampleAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(SampleAlg_extratags) build constituent_config -out=$(cmt_local_SampleAlg_makefile) SampleAlg; \
	  fi
endif
...
$(cmt_local_SampleAlg_makefile) : $(SampleAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building SampleAlg.make"; \
	  $(cmtexe) -f=$(bin)SampleAlg.in -tag=$(tags) $(SampleAlg_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SampleAlg_makefile) SampleAlg
else
$(cmt_local_SampleAlg_makefile) : $(SampleAlg_dependencies) $(cmt_build_library_linksstamp) $(bin)SampleAlg.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SampleAlg) ] || \
	  [ ! -f $(cmt_final_setup_SampleAlg) ] || \
	  $(not_SampleAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SampleAlg_extratags) build constituent_makefile -out=$(cmt_local_SampleAlg_makefile) SampleAlg

SampleAlg :: $(SampleAlg_dependencies) $(cmt_local_SampleAlg_makefile) dirs SampleAlgdirs
	$(echo) "(constituents.make) Starting SampleAlg"
	@if test -f $(cmt_local_SampleAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_SampleAlg_makefile) SampleAlg; \
	  fi
#	@$(MAKE) -f $(cmt_local_SampleAlg_makefile) SampleAlg
	$(echo) "(constituents.make) SampleAlg done"

clean :: SampleAlgclean

SampleAlgclean :: $(SampleAlgclean_dependencies) ##$(cmt_local_SampleAlg_makefile)
	$(echo) "(constituents.make) Starting SampleAlgclean"
	@-if test -f $(cmt_local_SampleAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_SampleAlg_makefile) SampleAlgclean; \
	fi
	$(echo) "(constituents.make) SampleAlgclean done"
#	@-$(MAKE) -f $(cmt_local_SampleAlg_makefile) SampleAlgclean

##	  /bin/rm -f $(cmt_local_SampleAlg_makefile) $(bin)SampleAlg_dependencies.make

install :: SampleAlginstall

SampleAlginstall :: $(SampleAlg_dependencies) $(cmt_local_SampleAlg_makefile)
	$(echo) "(constituents.make) Starting install SampleAlg"
	@-$(MAKE) -f $(cmt_local_SampleAlg_makefile) install
	$(echo) "(constituents.make) install SampleAlg done"

uninstall : SampleAlguninstall

$(foreach d,$(SampleAlg_dependencies),$(eval $(d)uninstall_dependencies += SampleAlguninstall))

SampleAlguninstall : $(SampleAlguninstall_dependencies) ##$(cmt_local_SampleAlg_makefile)
	$(echo) "(constituents.make) Starting uninstall SampleAlg"
	@if test -f $(cmt_local_SampleAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_SampleAlg_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SampleAlg_makefile) uninstall
	$(echo) "(constituents.make) uninstall SampleAlg done"

remove_library_links :: SampleAlguninstall
...
#cmt_local_tagfile_config = $(SampleAlg_tag)_config.make
cmt_local_tagfile_config = $(bin)$(SampleAlg_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)SampleAlg_configsetup.make
...
#cmt_local_tagfile_config = $(SampleAlg_tag).make
cmt_local_tagfile_config = $(bin)$(SampleAlg_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)SampleAlgsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(SampleAlg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(SampleAlg_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)SampleAlg_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(SampleAlg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(SampleAlg_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)SampleAlgsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(SampleAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(SampleAlg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)SampleAlg_makesetup.make
...
#cmt_local_tagfile_make = $(SampleAlg_tag).make
cmt_local_tagfile_make = $(bin)$(SampleAlg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)SampleAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(SampleAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(SampleAlg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)SampleAlg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(SampleAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(SampleAlg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)SampleAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(SampleAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(SampleAlg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)SampleAlg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(SampleAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(SampleAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)SampleAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(SampleAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(SampleAlg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)SampleAlg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(SampleAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(SampleAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)SampleAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(SampleAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(SampleAlg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)SampleAlg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(SampleAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(SampleAlg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)SampleAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(SampleAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(SampleAlg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)SampleAlg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(SampleAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(SampleAlg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)SampleAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(SampleAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(SampleAlg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)SampleAlg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(SampleAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(SampleAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)SampleAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(SampleAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(SampleAlg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)SampleAlg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(SampleAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(SampleAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)SampleAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
